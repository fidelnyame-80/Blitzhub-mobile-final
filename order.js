...
function payWithPaystack() {
  ...
  fetch(`https://script.google.com/macros/s/AKfycbwUlO-jzaNHAilzMktPJQUIFJdj3s-9a33SOjcNc6wLO49-tZY4ACGIVMDxmNRNtziI6g/exec?email=${encodeURIComponent(userEmail)}`)
    .then(res => res.json())
    .then(data => {
      if (data.alreadyPaid) {
